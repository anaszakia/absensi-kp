...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Jam Kerja</h1>
                <p class="text-sm text-gray-500 mt-1">Tambahkan pengaturan jam kerja baru untuk absensi</p>
            </div>
            <div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" 
                        ...
                        placeholder="Contoh: Shift Pagi, Jam Normal, dll" required>
                    @error('nama')
